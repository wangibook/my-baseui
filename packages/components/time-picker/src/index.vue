  ...
  <div class="m-time-picker-rel" v-inside>
    ...
    <transition name="slide-fade">
      ...
      >
        ...
        <div class="m-time-panel__footer" v-if="confirm">
          <button class="m-time-panel__btn" @click="handleClear">清空</button>
          <button class="m-time-panel__btn btn__confirm" @click="handleConfirm">确定</button>
        </div>
      </div>
    </transition>
  </div>
